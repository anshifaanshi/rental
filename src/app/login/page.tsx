      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-12">
          ...
          <div className="text-white">
            ...
            >
              Continue your journey with premium scooter rentals designed for freedom
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 accent-[#2c5f5f]"
                />
                <label htmlFor="remember" className="text-sm text-[#4a5f5f]">
                  Remember me
                </label>
              </div>
              <span className="text-sm text-[#2c5f5f] cursor-pointer hover:underline">
                Forgot Password?
              </span>
            </div>
